...
#                            print epochlist[epochnum-1][2][i/2][0]
                            lastsmoothedRange = epochlist[epochnum-1][2][i/2][0]
                            weight = sat[len(sat)-numSat*2+1]
                            newRange = smoothRange(pseudorange,lastsmoothedRange,doppler,weight)
                            smoothie.append(newRange)

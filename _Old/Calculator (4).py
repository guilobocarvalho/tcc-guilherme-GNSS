...
def smoothRINEX(fileName):
    ...
    #                print sat
                    if epochnum == 0:
                        satdict[sat] = [0,pseudorange] # Set initial weight to zero and initial pseudorange
                        newRangeline = '  ' + str(format(pseudorange,'.3f')) + line[14:62] + '\n'
    #                    print pseudorange
                    else:
                        if sat in satdict.keys():
                            satdict[sat][0] += 1 #adds one to the satellite weight
                            newRange = smoothRange(pseudorange,satdict[sat][1],doppler,satdict[sat][0])# calculates smoothed range
                            satdict[sat][1] = newRange
                            newRangeline = '  ' + str(format(newRange,'.3f')) + line[14:62] + '\n'
                        else:
                            satdict[sat] = [0,pseudorange] # create an entry for new satellite with zero weight
                            newRangeline = '  ' + str(format(pseudorange,'.3f')) + line[14:62] + '\n'
                    remove = []
    ...
    #                            if sat[len(sat)-numSat] == epochlist[epochnum-1][1][i]: # If satellite exists last epoch
    ...
    #                    print satdict
                        ...
                        epochnum +=1
        output = fileName[:-4]+'_Smoothed'+fileName[-4:]
...
#print
#print'RMS POS OFF'
#rmsPOS('20190115_Levantamento_8min_Original_GPS_GLONASS_OFF.pos')
#print
#print'RMS POS ON'
#rmsPOS('20190115_Levantamento_8min_Original_GPS_GLONASS.pos')
#print
#print'RMS POS RAIM e Iono+Tropo ON'
#rmsPOS('20190115_Levantamento_8min_Original_RAIM.pos')
#print
#print'RMS POS RAIM e Iono+Tropo OFF'
#rmsPOS('20190115_Levantamento_8min_Original_RAIM_OFF.pos')
#print
#print'RMS POS Completo RAIM e Iono+Tropo ON'
#rmsPOS('20190115_LevantamentoCompleto_Iono_On_Tropo_On_RAIM.pos')
#print
#print'RMS POS Completo RAIM e Iono+Tropo OFF'
#rmsPOS('20190115_LevantamentoCompleto_Iono_Off_Tropo_Off_RAIM.pos')
#print
#print'RMS POS Completo Iono+Tropo ON'
#rmsPOS('20190115_LevantamentoCompleto_Iono_On_Tropo_On.pos')
#print
#print'RMS POS Completo Iono+Tropo OFF'
#rmsPOS('20190115_LevantamentoCompleto_Iono_Off_Tropo_Off.pos')
#print
#
